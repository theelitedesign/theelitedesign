...
<body <?php body_class(); ?>> <?php wp_body_open(); ?>
	...
	<a class="skip-link screen-reader-text" href="#intro-section"><?php esc_html_e( 'Skip to content', 'devdives_td' ); ?></a>
								...
								<?php
									wp_nav_menu(
										array(
											...
											'fallback_cb'    => 'DevDives::nav_fallback',
											'walker'         => new DevDives\Walker\WP_Theme_Walker_Nav(),
											'container'      => 'nav',
										)
									);
								?>
