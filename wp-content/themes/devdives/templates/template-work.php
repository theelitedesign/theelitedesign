		...
		<div class="hero-blog hero">
			<div class="wrapper">
				<div class="hero-content">
					<h1 class="mb-0">Great Work <br><span>for Great People</span></h1>
				</div>
			</div>
		</div>
		<div class="el-s96"></div>
	...
	<div class="overflow-hidden">
		<div class="wrapper">
			...
			<?php
				...
				<?php
				if ( have_posts() ) {
					if ( class_exists( 'DevDives' ) && $ed_query->max_num_pages > 1 ) {
						?>
						<div class="center-align">
							<?php echo DevDives::pagination( $ed_query->max_num_pages ); ?>
						</div>
						<?php
					}
				}
