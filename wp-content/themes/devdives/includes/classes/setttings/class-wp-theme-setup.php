...
class WP_Theme_Setup {
	...
	public function setup_function() {
		...
		load_theme_textdomain( 'devdives_td' );
		...
		register_nav_menus(
			array(
				'header-nav'       => __( 'Header Nav', 'devdives_td' ),
				'footer-nav'   => __( 'Footer Nav', 'devdives_td' ),
				'legal-nav'        => __( 'Legal Nav', 'devdives_td' ),
			)
		);
