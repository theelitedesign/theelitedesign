...
class WP_Theme_Custom extends \Boilerplate {
	...
	public static function nav_fallback() {
		...
		if ( is_user_logged_in() ) {
			?>
			<ul>
				<li> <?php echo esc_html__( 'Go to admin area to create navigation menu', 'devdives_td' ); ?></li>
			</ul>
			<?php
		}
	}
...
class_alias( 'DevDives\Custom\WP_Theme_Custom', 'DevDives' );
