...
<section id="" class="page-section">
	...
	<div class="fixed-menu-nav">
		<div class="fixed-menu ctn-black">
			<a href="#faqs-general" class="button small">
				General
			</a>
			<a href="#faqs-web-design" class="button small">
				Web design
			</a>
			<a href="#faqs-web-development" class="button small">
				Web development
			</a>
			<a href="#faqs-seo" class="button small">
				Search engine optimization
			</a>
			<a href="#faqs-continuous-improvements" class="button small">
				Support / CI
			</a>
		</div>
	</div>
	...
	<section class="overflow-hidden">
		<div class="s-128"></div>
		<div class="wrapper">
			<div id="faqs-general" class="jumps-link__item jumplink-section"></div>
			<div class="hat-ctn flexarea sb">
				<div class="hat-title">
					<h2 class="heading-3">General</h2>
				</div>
				<div class="hat-text">
			...
			<div class="s-96"></div>
			<div id="faqs-web-design" class="jumps-link__item jumplink-section"></div>
			<div class="hat-ctn flexarea sb">
				<div class="hat-title">
					<h2 class="heading-3">Web Designs</h2>
				</div>
				<div class="hat-text">
					<div class="faqs__area">
						<div class="faqs__item">
			...
			<div class="s-96"></div>
			<div id="faqs-web-development" class="jumps-link__item jumplink-section"></div>
			<div class="hat-ctn flexarea sb">
				<div class="hat-title">
					<h2 class="heading-3">Web Development</h2>
				</div>
				<div class="hat-text">
					<div class="faqs__area">
						<div class="faqs__item">
			...
			<div class="s-96"></div>
			<div id="faqs-seo" class="jumps-link__item jumplink-section"></div>
			<div class="hat-ctn flexarea sb">
				<div class="hat-title">
					<h2 class="heading-3">Search Engine Optimization</h2>
				</div>
				<div class="hat-text">
					<div class="faqs__area">
						<div class="faqs__item">
			...
			<div class="s-96"></div>
			<div id="faqs-continuous-improvements" class="jumps-link__item jumplink-section"></div>
			<div class="hat-ctn flexarea sb">
				<div class="hat-title">
					<h2 class="heading-3">Support / CI</h2>
				</div>
				<div class="hat-text">
					<div class="faqs__area">
						<div class="faqs__item">
