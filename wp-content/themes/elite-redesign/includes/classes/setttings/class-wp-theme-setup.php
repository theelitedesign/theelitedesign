...
class WP_Theme_Setup {
	...
	public function setup_function() {
		...
		load_theme_textdomain( 'elitedesigns_td' );
		...
		register_nav_menus(
			array(
				'header-nav'       => __( 'Header Nav', 'elitedesigns_td' ),
				'footer-nav'   => __( 'Footer Nav', 'elitedesigns_td' ),
				'legal-nav'        => __( 'Legal Nav', 'elitedesigns_td' ),
			)
		);
