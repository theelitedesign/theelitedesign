...
?>
	...
	<div class="post-box-meta">
		<div class="post-author-ctn d-flex">
			<?php if($elitedesign_author_avatar){ ?>
				<div class="post-author-img"
					style="background-image: url(<?php echo $elitedesign_author_avatar; ?>); width:50px; height:50px; background-size:cover">
				</div>
			<?php } ?>
			<div class="author-meta">
				<?php if($elitedesign_author_name){ ?>
					<div class="post-author-name">By: <?php echo $elitedesign_author_name; ?></div>
				<?php } ?>
