...
$title                     = get_the_title();
$elitedesign_cpt_team_designation = $block_fields['elitedesign_cpt_team_designation'];
$elitedesign_cpt_team_text        = html_entity_decode($block_fields['elitedesign_cpt_team_text']);
?>
...
<article <?php post_class("single-member column"); ?>>
				...
				<div class="single-team-head d-flex flex-wrap justify-content-between align-items-center">
					...
					<div class="member-detail-popup">
						...
						<?php if ( $elitedesign_cpt_team_designation ) { ?>
							<h5 class="member-designation"><?php echo $elitedesign_cpt_team_designation; ?></h5>
						<?php } ?>
					</div>
				</div>
				<?php if ( $elitedesign_cpt_team_text ) { ?>
					<div class="single-team-content"><?php echo $elitedesign_cpt_team_text; ?></div>
				<?php } ?>
			</div>
		</div>
	</div>
	<a class="sm-inner open-popup-link" href="#post-<?php the_ID(); ?>">
		...
		<div class="t-detail">
			...
			<?php } ?>
			<?php if ( $elitedesign_cpt_team_designation ) { ?>
				<h5 class="designation"><?php echo $elitedesign_cpt_team_designation; ?></h5>
			<?php } ?>
		</div>
	</a>
